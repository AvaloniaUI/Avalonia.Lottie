...
namespace Avalonia.Lottie.Animation.Keyframe
{
    internal class ScaleKeyframeAnimation : KeyframeAnimation<ScaleXy>
    {
        ...
        public override ScaleXy GetValue(Keyframe<ScaleXy> keyframe, double  keyframeProgress)
        {
            ...
            return new ScaleXy(MathExt.Lerp(startTransform.ScaleX, endTransform.ScaleX, keyframeProgress),
                MathExt.Lerp(startTransform.ScaleY, endTransform.ScaleY, keyframeProgress));
        }
    }
}