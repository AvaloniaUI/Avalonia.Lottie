...
//         /// 0 or <see cref="Avalonia.Lottie.RepeatMode.Infinite"/>. Defaults to <see cref="Avalonia.Lottie.RepeatMode.Restart"/>.
//         /// Return either one of <see cref="Avalonia.Lottie.RepeatMode.Reverse"/> or <see cref="Avalonia.Lottie.RepeatMode.Restart"/>
//         /// </summary>
...
//         /// greater than 0 or <see cref="Avalonia.Lottie.RepeatMode.Infinite"/>, the repeat mode will be taken 
//         /// into account. The repeat count is 0 by default. 
//         /// 
//         /// Count the number of times the animation should be repeated
//         /// 
//         /// Return the number of times the animation should repeat, or <see cref="Avalonia.Lottie.RepeatMode.Infinite"/>
//         /// </summary>
