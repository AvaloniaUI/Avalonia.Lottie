...
namespace Avalonia.Lottie.Model
{
    ...
    public interface IKeyPathElement
    {
        ...
        ///     A list of fully resolved keypaths. If this element fully matches the keypath then it should
        ///     add itself to this list.
        /// </param>
        /// <param name="currentPartialKeyPath">
        ///     A keypath that contains all parent element of this one. This element should create
        ///     a copy of this and append itself with KeyPath#addKey when it adds itself to the accumulator or propagates
        ///     resolution to its children.
        /// </param>
